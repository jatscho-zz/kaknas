...
Component.options.__file = "/Users/zachy/Desktop/kaknas/kaknas-vue/src/components/Vuetable.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-10bf57b9", Component.options)
  } else {
    hotAPI.reload("data-v-10bf57b9", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    console.log('after', this.tableFields);
  ...
  methods: {
    ...
    normalizeFields: function normalizeFields() {
      ...
      console.log('before', this.tableFields);
      this.tableFields = [];
      var self = this;
      var obj = void 0;
    ...
    loadData: function loadData(sortOrder) {
      var _this = this;
      ...
      return this.fetch(this.apiUrl, this.httpOptions).then(function (response) {
        _this.firstres = response;
        return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(_this.diffUrl).then(function (response) {
          _this.secondres = response;
        }).catch(function () {
          return _this.loadDiffFailed('error');
        });
      }).catch(function () {
        return _this.loadModulesFailed('error');
      }).then(function (response) {
        return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(_this.commitsUrl).then(function (response) {
          _this.commitData = response.data.all_subpath_commits;
        }).catch(function () {
          return _this.loadCommitsFailed('error');
        });
      }).catch(function () {
        return _this.loadModulesFailed('error');
      }).then(function (response) {
        _this.loadSuccessDiff(_this.firstres, _this.secondres);
        _this.loadSuccessModules(_this.firstres);
      }).catch(function () {
        return _this.loadDiffFailed('error');
      });
    },
    fetch: function fetch(url, httpOptions) {
      return this.httpFetch ? this.httpFetch(url, httpOptions) : __WEBPACK_IMPORTED_MODULE_1_axios___default.a[this.httpMethod](url, httpOptions);
    },
    loadSuccessModules: function loadSuccessModules(res) {
      this.fireEvent('load-success', res);

      var body = this.transform(res.data);
      var sorted_keys = res.data.sorted_modules_keys[0];
      var reverse_keys = res.data.reversed_modules_keys[0];
      this.tableData = this.getObjectValue(body, this.dataPath, null);
      var newObj = [];
      if (res.data.sortOrder == 'asc') {
        for (var i = 0; i < sorted_keys.length; ++i) {
          newObj.push(this.tableData[sorted_keys[i]]);
        }
      } else {
        for (var i = 0; i < reverse_keys.length; ++i) {
          newObj.push(this.tableData[reverse_keys[i]]);
        }
      }
    ...
    loadSuccessDiff: function loadSuccessDiff(res, response) {
      var modulesInfo = res.data.data;
      var sortOrder = res.data.sortOrder;
      var diffInfo = response.data;
      for (var diff_key in diffInfo) {
        for (var i = 0; i < modulesInfo.length; ++i) {
          if (diffInfo[diff_key]["module_name"] == modulesInfo[i]["module_name"]) {
            this.colorMap[diffInfo[diff_key]["module_name"]] = {};
            this.colorMap[diffInfo[diff_key]["module_name"]]["id"] = i;
            for (var project in diffInfo[diff_key]) {
              if (project != "module_name") {
                this.colorMap[diffInfo[diff_key]["module_name"]][project] = true;
              }
            }
          }
        }
    ...
    loadModulesFailed: function loadModulesFailed(response) {
      this.fireEvent('load-modules-error', response);
      this.fireEvent('loaded');
    },
    loadCommitsFailed: function loadCommitsFailed(response) {
      this.fireEvent('load-commits-error', response);
      this.fireEvent('loaded');
    },
    loadDiffFailed: function loadDiffFailed(response) {
      console.error('load-diff-error', response);
      this.fireEvent('load-diff-error', response);
      this.fireEvent('loaded');
    },
    ...
    getDefaultSortParam: function getDefaultSortParam() {
      ...
      for (var i = 0; i < this.sortOrder.length; i++) {
        ...
        result += this.sortOrder[i].direction + (i + 1 < this.sortOrder.length ? ',' : '');
      }
      return result;
    },
    ...
    checkColor: function checkColor(itemIndex, item, field) {
      for (var key in item) {
        if (this.colorMap.hasOwnProperty(item[key])) {
          for (var project in item) {
            if (this.colorMap[item[key]].hasOwnProperty(project) && field["name"] == project) {
              return "background:rgba(241, 97, 170, 0.91)";
            }
          }
        }
      }
    ...
    onCellClicked: function onCellClicked(dataItem, field, event, tableFields) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Vuetable_vue__ = __webpack_require__(45);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_promise_polyfill__ = __webpack_require__(44);
...
// module
exports.push([module.i, "\n[v-cloak][data-v-10bf57b9] {\n  display: none;\n}\n.vuetable th.sortable[data-v-10bf57b9]:hover {\n  color: #2185d0;\n  cursor: pointer;\n}\n.vuetable-body-wrapper[data-v-10bf57b9] {\n  position:relative;\n  overflow-y:auto;\n}\n.vuetable-head-wrapper[data-v-10bf57b9] {\n  overflow-x: hidden;\n}\n.vuetable-actions[data-v-10bf57b9] {\n  width: 15%;\n  padding: 12px 0px;\n  text-align: center;\n}\n.vuetable-pagination[data-v-10bf57b9] {\n  background: #f9fafb !important;\n}\n.vuetable-pagination-info[data-v-10bf57b9] {\n  margin-top: auto;\n  margin-bottom: auto;\n}\n.vuetable-empty-result[data-v-10bf57b9] {\n  text-align: center;\n}\n.vuetable-clip-text[data-v-10bf57b9] {\n  white-space: pre-wrap;\n  text-overflow: ellipsis;\n  overflow: hidden;\n  display: block;\n}\n.vuetable-semantic-no-top[data-v-10bf57b9] {\n  border-top:none !important;\n  margin-top:0 !important;\n}\n.vuetable-fixed-layout[data-v-10bf57b9] {\n  table-layout: fixed;\n}\n.vuetable-gutter-col[data-v-10bf57b9] {\n  padding: 0 !important;\n  border-left: none  !important;\n  border-right: none  !important;\n}\n.vuetable tr[data-v-10bf57b9] {\n  cursor: pointer;\n}\n", ""]);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(107), __webpack_require__(43)))
  ...
  return _c('table', {
    ...
    return [_c('tr', {
      ...
      return [(field.visible) ? [(_vm.isSpecialField(field.name)) ? [(_vm.extractName(field.name) == '__sequence') ? _c('td', {
        ...
        style: (_vm.checkColor(itemIndex, item, field)),
        domProps: {
          "innerHTML": _vm._s(_vm.callCallback(field, item))
        },
        on: {
          "click": function($event) {
            _vm.onCellClicked(item, field, $event, _vm.tableFields)
          },
          "dblclick": function($event) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-10bf57b9", module.exports)
  }
}
...
var update = __webpack_require__(105)("6f008d68", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js?{\"minimize\":false,\"sourceMap\":false}!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-10bf57b9\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Vuetable.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js?{\"minimize\":false,\"sourceMap\":false}!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-10bf57b9\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Vuetable.vue");
